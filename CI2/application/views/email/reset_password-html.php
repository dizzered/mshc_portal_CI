...
<html>
<head><title>MSHC Portal: New User Password</title></head>
<body>
<div style="max-width: 800px; margin: 0; padding: 30px 0;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
<td align="left" style="font: 13px/18px Arial, Helvetica, sans-serif;">
<h3>THE MESSAGE HAS BEEN SENT TO E-MAIL ADDRESS SPECIFIED IN THE "E-MAIL" FIELD OF USER INFO</h3>
<br>
On <?php echo date('D, F j, Y, g:ia'); ?>
<br /><br>
You are resetting user password in <?php echo MSHC_COMPANY_NAME; ?>.
<br><br>
